...
#     permg = Gcorner.nodes()
    ...
    return (all_graphs, BBD, index_order)

def random_bordered_block_diagonal_matrix(block_sizes, border_size, min_value=0, max_value=10):
...
csr_pm = csr_matrix(pmm)
all_graphs, BBD, index_order = admittance_to_BBD(csr_pm, 10)
