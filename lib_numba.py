    ...
    for i in numba.prange(gen_genrou_n):
        ...
        if len(idx_pss1)==0:
            ...
            if pss_ieeest_T2[idx_pss] == 0.0:
                ...
                temp_nx_y5 = pv_y5 + (pv_y4 - pv_y5) / pss_ieeest_T2[idx_pss] * ts + (temp_nx_y4 - pv_y4) * pss_ieeest_T1[idx_pss] / pss_ieeest_T2[idx_pss]
        ...
        if gov_type[i] == 2: # 'TGOV1'
            ...
            temp_nx_p1 = pv_p1 + ((gref[tgov1_2gen[idx_gov]] - gov_input) / gov_tgov1_R[idx_gov] - pv_p1) / gov_tgov1_T1[idx_gov] * ts
